                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group" dir="rtl">
                              <label  class="text-right float-right" for="">العميل</label>
                          <select  class="form-control" name="clients_id" id="">
                              @foreach ($clints as $clint)
                              <option value="{{ $clint->id }}">{{ $clint->name }}</option>
                              @endforeach
                          </select>
                      </div>
                    </div>
...
<input type="hidden" name="type" value="{{ $type }}">
                ...
                <div class="form-group">
                    <a href="/invoices?type=selling" class="btn btn-block btn-outline-primary btn-sm">رجوع</a>
                </div>
                    </div>
                  </div>
