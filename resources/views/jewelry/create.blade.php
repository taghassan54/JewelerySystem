    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <div class="card card-primary card-outline">
          ...
          <div class="card-body" >
            <form action="{{ route('jewelry.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row" dir="rtl">
                    ...
                    <div class="col-6">
                            ...
                            <div class="form-group " dir="rtl">
                                ...
                                <div class="form-group " dir="rtl">
                                        <label for=""></label>
                                        <input type="text" name="matrial_weight" class="form-control" placeholder=" الوزن " required>
                                    </div>

                    </div>
                    <div class="col-12">
                            <div class="form-group " dir="rtl">
                        <textarea name="description" id="description" cols="30" rows="10" class="form-control" placeholder="الوصف" required></textarea>
                    </div>
                    </div>
