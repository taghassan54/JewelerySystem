          ...
          <div class="card-body" >
            <form action="{{ route('supplier.update',$supplier->id) }}" method="post">
                ...
                <div class="form-group col-md-6 offset-3" dir="rtl">
                    <input type="text" value="{{ $supplier->name }}" name="name" class="form-control" placeholder="الأسم" required>
                </div>
                ...
                <div class="form-group col-md-6 offset-3">
                    <a href="/supplier" class="btn btn-block btn-outline-primary btn-sm">رجوع</a>
